...
$connection = mysqli_connect($HostName, $DatabaseUsername, $DatabasePassword, $DatabaseName);
...
//     $CheckSQL = "INSERT INTO users (name, email, password) values ('$name','$email','$password')";
